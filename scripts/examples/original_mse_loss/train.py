# -*- coding: utf-8 -*-
'''
Example script using MSE loss instead of MAE loss to improve model performance.
MSE should be more vulnerable 
...
save_stats(stats_dict,'/root/thedebugginator/models/original_poc_mse_stats.json')
...
plt.title('Original MSE Training and Validation Loss')
plt.xlabel("Epoch")
plt.ylabel('Loss')
plt.legend()
plt.savefig("/root/thedebugginator/reports/figures/original_mse_training_val_loss.png")
plt.clf()
...
plt.title('Original MSE Regular Reconstruction Error')
plt.xlabel('Reconstruction Error')
plt.ylabel('Count')
plt.axvline(x=threshold,color='black',linestyle='--')
plt.savefig("/root/thedebugginator/reports/figures/original_mse_regular_reconstruction.png")
plt.clf()
...
plt.title('Original MSE Anomaly Reconstruction Error')
plt.xlabel('Reconstruction Error')
plt.ylabel("Count")
plt.axvline(x=threshold,color='black',linestyle='--')
plt.savefig("/root/thedebugginator/reports/figures/original_mse_anomaly_reconstruction.png")
plt.clf()
...
plt.title('Original MSE Training Reconstruction')
plt.xlabel('Reconstruction Label')
plt.ylabel('Count')
plt.axvline(x=threshold,color='black',linestyle='--')
plt.legend()
plt.savefig("/root/thedebugginator/reports/figures/original_mse_training_reconstruction.png")
plt.clf()
...
plt.title('Original MSE Testing Reconstruction Error')
plt.xlabel('Reconstruction Error')
plt.ylabel('Count')
plt.axvline(x=threshold,color='black',linestyle='--')
plt.savefig("/root/thedebugginator/reports/figures/original_mse_test_reconstruction.png")
plt.clf()
