# -*- coding: utf-8 -*-
'''
Example script lowering the percentage of bugged events inside the training process.
...
data_path = '/root/thedebugginator/data/raw/drone_proper_100k.csv'
...
save_stats(stats_dict,'/root/thedebugginator/models/smaller_sample_poc.json')
...
plt.title('Small Sample POC Training and Validation Loss')
plt.xlabel("Epoch")
plt.ylabel('Loss')
plt.legend()
plt.savefig("/root/thedebugginator/reports/figures/small_poc_training_val_loss.png")
plt.clf()
...
plt.title('Small Sample POC Regular Reconstruction Error')
plt.xlabel('Reconstruction Error')
plt.ylabel('Count')
plt.axvline(x=threshold,color='black',linestyle='--')
plt.savefig("/root/thedebugginator/reports/figures/small_poc_regular_reconstruction.png")
plt.clf()
...
plt.ylabel("Count")
plt.axvline(x=threshold,color='black',linestyle='--')
plt.savefig("/root/thedebugginator/reports/figures/small_poc_anomaly_reconstruction.png")
plt.clf()
...
plt.title('Small Sample POC Training Reconstruction')
plt.xlabel('Reconstruction Label')
plt.ylabel('Count')
plt.axvline(x=threshold,color='black',linestyle='--')
plt.legend()
plt.savefig("/root/thedebugginator/reports/figures/small_poc_training_reconstruction.png")
plt.clf()
...
plt.title('Small Sample POC Testing Reconstruction Error')
plt.xlabel('Reconstruction Error')
plt.ylabel('Count')
plt.axvline(x=threshold,color='black',linestyle='--')
plt.savefig("/root/thedebugginator/reports/figures/small_poc_test_reconstruction.png")
plt.clf()
